 ...
 * spi1.h
 *
 *  Header for the SPI1 interface driver of the BCM2835.
...
#define     SPI1_LOSSI_MODE              0x00000080     // Interface will be in SoSSI mode
...
typedef enum
{
    SPI1_DATA_RATE_32KHZ  = 3906,
    SPI1_DATA_RATE_64KHZ  = 1952,
    SPI1_DATA_RATE_128KHZ = 976,    // Default
    SPI1_DATA_RATE_256KHZ = 488,
    SPI1_DATA_RATE_512KHZ = 244,
    SPI1_DATA_RATE_1MHZHZ = 124,
    SPI1_DATA_RATE_2MHZ   = 62,
    SPI1_DATA_RATE_4MHZ   = 30,
    SPI1_DATA_RATE_8MHZ   = 14,
    SPI1_DATA_RATE_14MHZ  = 8,
} spi1_clock_div_t;


int  bcm2835_spi1_init(uint32_t configuration);              // Initialization
void bcm2835_spi1_close(void);                               // Close SPI0 device
void bcm2835_spi1_set_rate(spi1_clock_div_t data_rate);      // Set SPI transfer data rate
